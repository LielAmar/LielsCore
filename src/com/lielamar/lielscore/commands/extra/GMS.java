	...
	public boolean onCommand(CommandSender cs, Command cmd, String cmdLabel, String[] args) {
		...
		if(cmd.getName().equalsIgnoreCase("gms")) {
			...
			if(args.length == 0) {
				...
				p.sendMessage(ChatColor.GRAY + "Gamemode changed to " + ChatColor.YELLOW + "Survival" + ChatColor.GRAY + "!");
				return true;
			}
			...
			t.sendMessage(ChatColor.GRAY + "Gamemode changed to " + ChatColor.YELLOW + "Survival" + ChatColor.GRAY + "!");
			p.sendMessage(ChatColor.BLUE + t.getName() + ChatColor.GRAY + "'s Gamemode changed to " + ChatColor.YELLOW + "Survival" + ChatColor.GRAY + "!");
			return true;
		}
		return true;
	}
